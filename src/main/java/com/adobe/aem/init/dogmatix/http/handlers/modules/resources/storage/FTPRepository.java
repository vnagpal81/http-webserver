...
/**
 * Represents a file repository on a FTP server.
 * 
 * Performs the operations via FTP.
 * 
 * Parameters required to connect to a FTP repository:
 * FTP Host				:	hostname	
 * Port					:	port (default 25)
 * Auth credentials		:	userid, password
 * Connect Mode			:	passive, active
 * Connection Type 		:	ascii, binary
 * 
 * @author vnagpal
 *
 */
